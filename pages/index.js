...
export default function Home({ skills, projects }) {
  ...
  return (
    ...
    >
      <Head>
        <title>Pratham Saraf</title>
        <meta name="description" content="Portfolio of Pratham Saraf" />
        <meta
          name="og:title"
          content="Pratham Saraf - Machine Learning Enthusiast"
        />
        <meta name="og:description" content="Portfolio of Pratham Saraf" />
      </Head>
